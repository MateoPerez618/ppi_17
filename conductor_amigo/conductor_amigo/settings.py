"""
Django settings for conductor_amigo project.
...
# personalizados para gestionar sus configuraciones especificas.
...
SECRET_KEY = 'django-insecure-$p(ujrx(ujokvbi_p$fv3#q2&$h)6rd$3yh&3(#gernwqw@q2o'
...
ROOT_URLCONF = 'conductor_amigo.urls'
...
WSGI_APPLICATION = 'conductor_amigo.wsgi.application'
